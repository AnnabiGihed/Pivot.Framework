...
namespace Templates.Core.Authentication.Maui.Blazor;

/// <summary>
/// Author      : Gihed Annabi
/// Date        : 02-2026
/// Purpose     : Blazor <see cref="AuthenticationStateProvider"/> backed by <see cref="IKeycloakAuthService"/>.
...
/// </summary>
public sealed class KeycloakAuthStateProvider : AuthenticationStateProvider, IDisposable
{
	#region Fields
